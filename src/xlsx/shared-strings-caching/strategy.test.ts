...
describe('CachingStrategyFactory', () => {
  test('should create in-memory strategy for small counts', () => {
  ...
  test('should create file-based strategy when count is unknown', () => {
  ...
  test('should use file-based strategy for very large counts', () => {
  ...
  test('should use in-memory strategy when memory is sufficient', () => {
    const count = 1000;
    // Calculate memory needed: entry overhead in bytes, converted to KB
  ...
  test('should use file-based strategy when memory limit is very small', () => {
  ...
  test('should use file-based strategy when memory limit is insufficient', () => {
  ...
  test('static method should work with default memory limit', () => {
